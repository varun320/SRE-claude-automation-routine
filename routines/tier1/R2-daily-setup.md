...
> Top 3 for Mon (Sale-Process theme):
...
> 3. **DD-tracker reconciliation** — output: tracker reflects May 21 advisor call · 20 min · 13:35–13:55 · risk: low
>
...
Delivered to: Outlook self-DM or Teams self-chat (same channel as R1).
...
- **Failure mode:** If filesystem or ms365 errors, route the failure notification per Phase 0 Open Question #4 — Outlook inbox or Teams self-DM. Do NOT retry silently.
